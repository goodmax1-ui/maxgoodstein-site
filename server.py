...
<head>
  ...
  <meta name="description" content="{data["name"]} — {data["tagline"]}">
...
{chr(10).join(links_lines)}
    ...
    <p class="footer">&copy; 2026 {data["name"]}</p>
  </main>
</body>
</html>"""
    return html
...
class Handler(SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        elif path.startswith("/uploads/") or path.endswith((".png", ".jpg", ".jpeg", ".gif", ".webp", ".svg")):
            super().do_GET()
        else:
            self.send_error(404)
