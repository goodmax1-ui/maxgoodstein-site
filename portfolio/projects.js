// Portfolio content — edit the text here, nothing else on the page needs touching.
//
// Each project has:
//   title - project name (card heading)
//   meta  - the small grey line: role, agency, borough, year
//   desc  - the paragraph description
//   hero  - page number of the big image on the card (see pages list)
//   pages - [page number, caption] for each sheet, in gallery order.
//           Images live in img/pNN.webp (p01-p35).
//
// After editing: save, then commit + push (or ask Claude to).

const PROJECTS = [
  {
    title: "Haffen Park Pool Complex Reconstruction",
    meta: "Designer & Drafter · NYC Parks Capital Projects · Bronx · 2023",
    ...
    pages: [
      ...
      [3, "Layout & materials plan"],
      [4, "Grading, drainage & site electrical plan"],
      [5, "Site details — underground detention & outlet control"],
      [6, "Existing pool deck & landscape layout"],
      [7, "Proposed pool deck & landscape plan"],
      [8, "Burke Ave & Ely Ave entrance — existing"],
      [9, "Burke Ave & Ely Ave entrance — proposed ADA ramp"],
      [10, "Entrance circulation during pool season"],
      [11, "Pool deck — existing"],
      [12, "Pool deck — proposed"],
      [13, "Wading pool — existing"],
      [14, "Wading pool — proposed, ADA accessible"]
    ]
  },
  {
    title: "Clove Lakes Park Pavement Reconstruction",
    meta: "Project Manager, Designer & Drafter · NYC Parks Capital Projects · Staten Island · 2023",
    ...
    pages: [
      [15, "Title sheet"],
      [16, "Reconstruction plan — sheet 1"],
      [17, "Reconstruction plan — sheet 2"],
      [18, "Reconstruction plan — sheet 3"],
      [19, "Site details — swales & edging"],
      [20, "Site details — inlet, headwall outfall & riprap"]
    ]
  },
  {
    title: "Brower Park Pathway Reconstruction",
    meta: "Designer & Drafter · NYC Parks Capital Projects · Brooklyn · 2021",
    ...
    pages: [
      [21, "Title sheet"],
      [22, "Tree protection & removals plan"],
      [23, "Layout, materials & grading plan — Shirley Chisholm Circle detail"],
      [24, "Post & chain fence details"]
    ]
  },
  {
    title: "Claremont Park Play Area & Sports Courts",
    meta: "Designer & Drafter · NYC Parks Capital Projects · Bronx · 2022",
    ...
    pages: [
      [25, "Title sheet"],
      [26, "Layout, materials & grading plan"]
    ]
  },
  {
    title: "William F. Passannante Ballfield Reconstruction",
    meta: "Designer & Drafter · NYC Parks Capital Projects · Manhattan · 2022",
    desc: "Reconstruction of the ballfield at West Houston Street and Avenue of the Americas: color-sealed softball, hockey, and basketball surfaces, new benches, sidewalk and street tree work — all coordinated over the active subway tunnel directly below the site.",
    hero: 28,
    pages: [
      [27, "Title sheet"],
      [28, "Layout & materials plan"]
    ]
  },
  {
    ...
    pages: [
      [29, "Title sheet"],
      [30, "Removals & protection plans"],
      [31, "Layout, materials & grading plan"]
    ]
  },
  {
    title: "Brooklyn Basketball Courts Reconstruction",
    meta: "Designer & Drafter · NYC Parks Capital Projects with NYC DEP · Brooklyn · 2021–23",
    ...
    pages: [
      [32, "Title sheet"],
      [33, "Taaffe Playground — layout plan"],
      [34, "Star Spangled Playground — layout plan"],
      [35, "Potomac Playground — layout plan"]
    ]
  }
];
